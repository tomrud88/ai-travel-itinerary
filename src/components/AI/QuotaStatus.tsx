        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-red-700 mb-2">
              You've reached the monthly limit for AI-generated itineraries. The
              app will use sample itineraries instead.
            </p>
            <div className="text-xs text-red-600 space-y-1">
              <p>
                • Monthly usage: {stats.monthlyUsed}/{stats.monthlyLimit}{" "}
                requests
              </p>
              <p>• Resets on: First day of next month</p>
              <p className="mt-2 font-medium">
                To continue using AI features, consider upgrading to a paid
                Gemini API plan.
              </p>
            </div>
          </div>
    ...
    <div className={`mb-4 p-3 rounded-lg border ${getStatusColor()}`}>
      <div className="flex items-center justify-between mb-2">
        ...
        <span className="text-sm font-semibold">
          {stats.monthlyUsed}/{stats.monthlyLimit}
        </span>
      </div>
      ...
      <div className="text-xs space-y-1">
        <p>
          • Daily: {stats.dailyUsed}/{stats.dailyLimit}
        </p>
        <p>
          • Per minute: {stats.minuteUsed}/{stats.minuteLimit}
        </p>
        {stats.percentageUsed >= 80 && stats.percentageUsed < 100 && (
          <p className="mt-2 font-medium">
            ⚠️ Approaching monthly limit. App will use sample itineraries when
            quota is exceeded.
          </p>
        )}
      </div>
